...
from core.constants import DEFAULT_USER, DEFAULT_USER_HOME, DEFAULT_OWNER_GROUP
...
KEY_STORE_GENERATOR_JAVA_CLUSTER_PATH = f"{DEFAULT_USER_HOME}/JavaKeyStore.java"
KEY_STORE_GENERATOR_JAVA_COMPILED_CLASSES_DIR = f"{DEFAULT_USER_HOME}/compiled_java/"
...
class SSLDefaultConfigs(Enum):
    ...
    HOME_SYSTEST_CERTS = f"{DEFAULT_USER_HOME}/certs/"
    CERT_EXTENSION = "cert"
...
class HadoopCluster:
    ...
    def _generate_keystore(self,
        ...
        self._executor.modify_file_permissions(*roles, file=file, owner_group=DEFAULT_OWNER_GROUP, permission=755)
        return file
